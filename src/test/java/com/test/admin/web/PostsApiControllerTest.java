...
public class PostsApiControllerTest {
    ...
    public void Posts_등록된다() throws Exception {
        ...
        //when
        ResponseEntity<Long> reesponseEntity = restTemplate.postForEntity(url, requestDto, Long.class);

        //then

        assertThat(reesponseEntity.getStatusCode()).isEqualTo(HttpStatus.OK);
        assertThat(reesponseEntity.getBody()).isGreaterThan(0L);
